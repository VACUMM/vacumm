...
ref2 = ref1*1.2
# - ensemble 1
dat1 = (MV2.resize(ref1, (nens, nt)) +
        N.resize(N.random.rand(nt*nens), (nens, nt))*20.)
dat1.long_name = 'Set 1'
dat1.units = 'meters'
# - modele 2
dat2 = (MV2.resize(ref2, (nens, nt)) +
        N.resize(N.random.rand(nt*nens), (nens, nt))*40.)
