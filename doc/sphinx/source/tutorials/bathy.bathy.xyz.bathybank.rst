.. _tut.bathy.bathy.xyz.bathybank:
...
.. note::
	...
	Dans l'exemple ci-dessous, le fichier de recensement des bathymétries
	est spécifié manuellement. Vous n'aurez normalement pas à le spécifier
	car il en existe un par défaut.
