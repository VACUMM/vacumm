...
for ilh,resdst  in enumerate(['basse', 'haute']):
    ...
    curve2(vremap, 'o', markersize=2, label=u'Remapping', linewidth=1.2, color='b', **kwplot)
    curve2(vlinear, 'o', markersize=2, label=u'Interpolation', linewidth=1.2, color='r', **kwplot)
    yscale(1.1)
